...
<head>
    ...
    <link rel="icon" type="image/png" img src="{{ asset('img/logo.png') }}">
    <title>
        Admin Dashboard
    </title>
...
<body class="g-sidenav-show   bg-gray-100">
    ...
    {{-- <div class="min-height-300 " style="background-image: url('{{ asset('img/login3.jpg') }}'); background-position:center; background-size: cover; background-repeat: no-repeat; position: absolute; width: 100%; min-height: 300px;">
    </div> --}}
    {{--   <div class="page-header align-items-start min-vh-40 pt-5 pb-6 m-3 border-radius-lg" bg-primary style="background-image: url('{{ asset('img/login3.jpg') }}'); background-position: center; background-size: cover; background-repeat: no-repeat; height: 40vh;">
    </div> --}}
