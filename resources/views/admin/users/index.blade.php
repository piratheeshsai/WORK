                                    ...
                                    @foreach ($users as $user)
                                        <tr>
                                                ...
                                                <div class="d-flex px-2 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        ...
                                                        <p class="text-xs text-secondary mb-0">
                                                            {{ optional($user->userDetails)->email ?? 'No Email' }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <span
                                                    class="text-secondary text-xs font-weight-bold">{{ optional($user->userDetails)->subsection ?? 'Empty' }}</span>
                                            </td>
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-secondary text-xs font-weight-bold">{{ optional($user->userDetails)->EmployeeId ?? 'No ID' }}</span>
                                            </td>
                                            <td class="align-middle text-center text-sm">
